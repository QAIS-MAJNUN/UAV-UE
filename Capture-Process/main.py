...
def image_single_capture(picture_num):
    picture_num += 1
    ...
    if responses:
        ...
        if image_response is not None and len(image_response.image_data_uint8) > 0:
            ...
            # 保存图像
            cv2.imwrite(scenepath + "Scene" + str(picture_nums + picture_num) + "_" + str(height) + "_" + str(i * 5) + "_" + SceneName + ".png", img_rgb)
        else:
    ...
    if responses:
        ...
        if response is not None and len(response.image_data_uint8) > 0:
            ...
            # 保存图像
            cv2.imwrite(segmentationpath + "Segmentation" + str(picture_nums + picture_num) + "_" + str(height)
                            + "_" + str(i * 5) + "_" + SceneName + ".png", img_rgb)
        ...
        for i in range(19):
            ...
            if responses:
                ...
                if image_response is not None and len(image_response.image_data_uint8) > 0:
                    ...
                    # 保存图像
                    cv2.imwrite(scenepath + "Scene" + str(picture_nums + picture_num) + "_" + str(height)
                                + "_" + str(i * 5) + "_" + SceneName + ".png", img_rgb)
                else:
                    print("No Scene image data received.")
            else:
            ...
            # BoxTruck      48      [85, 152, 34]       LargeVehicle
            # Bulldozer     57      [51, 155, 241]      MediumVehicle
            # Excavator     90      [114, 161, 30]      MediumVehicle
            # ForkLift      93      [46, 104, 76]       MediumVehicle
            # Jeep          109     [3, 177, 32]        MediumVehicle
            # Motor         178     [138, 223, 226]     SmallVehicle
            # Pickup        192     [154, 159, 251]     MediumVehicle
            # RoadRoller    189     [235, 208, 124]     MediumVehicle
            # Sedan         245     [70, 209, 228]      MediumVehicle
            # SUV           172     [230, 136, 198]     MediumVehicle
            # Trailer       156     [129, 235, 107]     LargeVehicle
            # Truck         239	    [10, 160, 82]       LargeVehicle
            # Van           149     [95, 224, 39]       MediumVehicle
            ...
            if responses:
                ...
                if response is not None and len(response.image_data_uint8) > 0:
                    ...
                    # 保存图像
                    cv2.imwrite(surfacenormalspath + "SurfaceNormals" + str(picture_nums + picture_num) + "_" + str(height)
                                + "_" + str(i * 5) + "_" + SceneName + ".png", img_rgb)
            ...
            if responses:
                ...
                if response is not None and len(response.image_data_uint8) > 0:
                    ...
                    # 保存图像
                    cv2.imwrite(infraredpath + "Infrared" + str(picture_nums + picture_num) + "_" + str(height)
                                + "_" + str(i * 5) + "_" + SceneName + ".png", img_rgb)
            ...
            #
            #         # 保存图像
            #         cv2.imwrite(depthperspectivepath + "DepthPerspective" + str(picture_nums + picture_num) + "_" + str(height)
            #                     + "_" + str(i * 5) + "_" + SceneName + ".png", img_rgb)
            #
            #     else:
            ...
            #
            #         # 保存图像
            #         cv2.imwrite(depthplanarpath + "DepthPlanar" + str(picture_nums + picture_num) + "_" + str(height)
            #                     + "_" + str(i * 5) + "_" + SceneName + ".png", img_rgb)
            #
            #     else:
            ...
            if responses:
                ...
                if response is not None and len(response.image_data_uint8) > 0:
                    ...
                    # 保存图像
                    cv2.imwrite(depthvispath + "DepthVis" + str(picture_nums + picture_num) + "_" + str(height)
                                + "_" + str(i * 5) + "_" + SceneName + ".png", img_rgb)
...
while True:
    ...
    # 根据 'L' 按键来拍摄单张数据集
    if scan_wrapper[pygame.K_l]:
        picture_num = image_single_capture(picture_num)
        # key_countersingle = 3
